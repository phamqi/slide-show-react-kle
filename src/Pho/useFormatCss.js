...
export default function FormatCss(style) {
  ...
  .section__wrap__pic_${randomValue} {
    
  }
  .section___${randomValue}wrap__pic {
    width: min(100%, max((calc(576px - 100vw)*9999),50%));
  }
  .section__pic_${randomValue} {
    width: 100%;
    border-radius: 0.5rem;
  }
  .section__txt_${randomValue} {
    padding: 1rem max(0px, min( calc((100vw - 576px)*99999), 1.75rem)) 0;
    display: flex;
    flex-direction: column;
    box-sizing: border-box;
    width: min(100%, max((calc(576px - 100vw)*9999),50%));
  }
  .section__info_${randomValue} {
    margin: 0.75rem 0;
    overflow: hidden;
    display: -webkit-box;
  ...
  .section__link_${randomValue} {
    margin-top: auto;
  }
  .left_arrow_${randomValue} {
    width: 30px;
    height: 30px;
    color: rgb(244, 88, 122);
  }
  .right_arrow_${randomValue} {
    width: 30px;
    height: 30px;
    color: rgb(244, 88, 122);
  }
